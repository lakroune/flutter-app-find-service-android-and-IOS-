...
import 'package:s5/src/Widget/bezierContainer.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:s5/src/infouser.dart';

import '../MyScreen/Screen/Racine.dart';

class SignUpPage extends StatefulWidget {
  static const screanRoute = "SignUpPage";
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  inscrire() async {
    if (password1.text != password2.text || password1.text.length < 6) {
      Fluttertoast.showToast(
          msg: "verifier mot de passe  (6 caractere)",
    ...
    if (resultat == "email existe") {
      ...
      Fluttertoast.showToast(
          msg: " la compte est cree",
          gravity: ToastGravity.CENTER,
          backgroundColor: Colors.green);
      Navigator.pushNamed(context, InfoUser.screanRoute);
