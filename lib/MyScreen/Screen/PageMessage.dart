...
class MyMessage extends StatefulWidget {
  static const screanRoute = "MyMessage";
        ...
        child: Column(
          ...
          children: [
            StreamBuilder<QuerySnapshot>(
                stream: _fireStore
                    .collection('messages$idUser$idService')
                    .orderBy("time")
                    .snapshots(),
                  ...
                  IconButton(
                    onPressed: () async {
                      if (messageController.text != "") {
                        _fireStore.collection('messages$idUser$idService').add({
                          'idUser': idUser,
                          "idService": idService,
                          'message': messageText,
                        ...
                        client.envoyerMessage(
                            idService: idService!, message: messageText!);
                      }
